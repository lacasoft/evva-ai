...
export const ONBOARDING_MESSAGES = {
  ...
  READY_YOUNG: (name: string, interests: string[]) =>
    ...
    (interests.includes('google') ? `- Conectar tu Gmail y Calendario (dime "Conecta mi Google")\n` : '') +
    (interests.includes('notes') ? `- Crear notas, listas y recordatorios\n` : '') +
    (interests.includes('search') ? `- Buscar en internet y darte noticias\n` : '') +
  ...
  READY_ADULT: (name: string, interests: string[]) =>
    ...
    (interests.includes('finance') ? `- Gestión de finanzas (gastos, tarjetas, ahorro)\n` : '') +
    (interests.includes('google') ? `- Email y calendario (dime "Conecta mi Google")\n` : '') +
    (interests.includes('notes') ? `- Notas, listas y recordatorios\n` : '') +
    (interests.includes('health') ? `- Seguimiento de hábitos y medicamentos\n` : '') +
  ...
  READY_SENIOR: (name: string, interests: string[]) =>
    ...
    `Te puedo ayudar con:\n` +
    (interests.includes('medications') ? `- Recordarte tus medicamentos a la hora indicada\n` : '') +
    (interests.includes('emergency') ? `- Guardar contactos de emergencia\n` : '') +
    (interests.includes('notes') ? `- Recordatorios y notas importantes\n` : '') +
